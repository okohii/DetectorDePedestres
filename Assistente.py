...
def executar_tarefa(comando, language='pt-BR'):
    if verificar_comando(comando, ['olá', 'oi', 'hello', 'hi', 'hey', 'e aí', 'e ai', 'tudo bem', 'tá bem', 'como vai', 'como está', 'how are you', 'how are you doing', 'how do you do']):
        ...
        lista_nao_entendi = ["Ta tirando? Fala direito.", "Pode falar de novo?", "Não entendi nada, fala direito porra."] if language == 'pt-BR' else ["Are you kidding? Speak properly.", "Can you say that again?", "I didn't understand anything, speak properly."]
        falar(random.choice(lista_nao_entendi))
